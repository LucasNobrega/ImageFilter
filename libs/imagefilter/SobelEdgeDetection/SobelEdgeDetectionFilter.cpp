...
SobelEdgeDetectionFilter::SobelEdgeDetectionFilter() : AbstractFilter()
{
}

SobelEdgeDetectionFilter::SobelEdgeDetectionFilter(
    const SobelEdgeDetectionFilter &other)
    : AbstractFilter(other)
{
}

SobelEdgeDetectionFilter &SobelEdgeDetectionFilter::operator=(
    const SobelEdgeDetectionFilter &other)
{
    if (this != &other)
    {
...
bool SobelEdgeDetectionFilter::apply()
{
    ...
    cv::Mat output1;
    cv::Mat kernel1 = (cv::Mat_<double>(kernel_size, kernel_size) << -1,
                       0,
                       1,
                       -2,
                       0,
    ...
    cv::Mat output2;
    cv::Mat kernel2 = (cv::Mat_<double>(kernel_size, kernel_size) << 1,
                       2,
                       1,
                       0,
                       0,
