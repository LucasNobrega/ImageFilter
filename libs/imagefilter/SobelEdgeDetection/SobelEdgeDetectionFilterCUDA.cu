...
SobelEdgeDetectionFilterCUDA::SobelEdgeDetectionFilterCUDA( unsigned int filter_kernel_width,
...
SobelEdgeDetectionFilterCUDA::SobelEdgeDetectionFilterCUDA(const SobelEdgeDetectionFilterCUDA& other)
: AbstractFilterCUDA(other)
{
    cuda_kernel = other.cuda_kernel;
}

SobelEdgeDetectionFilterCUDA& SobelEdgeDetectionFilterCUDA::operator=(const SobelEdgeDetectionFilterCUDA& other) {
    if(this != &other){
